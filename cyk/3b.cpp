...
bool cyk(char *s)
{
    ...
    for(l = 0; l<50 && s[l]!=0; l++)
        switch(s[l])
        {
            case '(': M[l][l].insert('E'); break;
            case ')': M[l][l].insert('F'); break;
            case '[': M[l][l].insert('G'); break;
            case ']': M[l][l].insert('H'); break;
            case '{': M[l][l].insert('I'); break;
            case '}': M[l][l].insert('J'); break;
